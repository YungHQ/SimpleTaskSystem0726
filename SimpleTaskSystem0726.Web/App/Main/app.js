        ...
        function ($stateProvider, $urlRouterProvider, $locationProvider, $qProvider) {
            ...
            $stateProvider
                .state('home', {
                    ...
                    menu: 'Home' //Matches to name of 'Home' menu in SimpleTaskSystem0726NavigationProvider
                })
                .state('about', {
                    url: '/about',
                    templateUrl: '/App/Main/views/about/about.cshtml',
                    menu: 'About' //Matches to name of 'About' menu in SimpleTaskSystem0726NavigationProvider
                })
                .state('tasklist', {
                    url: '/tasklist',
